...
import { calendarApi, aiApi, type CalendarEvent, type AiSlot } from "../api/client.ts";
            ...
            {showFindTime && (
              <div className="rounded-xl p-3 space-y-2" style={{ background: "var(--c-surface-container-high)", border: "1px solid var(--c-outline-variant)" }}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    {aiBusy ? <span className="material-symbols-outlined animate-spin text-sm">progress_activity</span> : <span className="material-symbols-outlined text-sm">search</span>}
                    Find
                  </button>
                </div>
