...
import { adminApi, type PolicyUser, type RoleChangeRecord } from "../../api/client";
        ...
        {(["super_admin", "manager_admin", "user"] as const).map((r) => {
          ...
          return (
            <div key={r} className="glass-panel rounded-2xl p-5 flex items-center gap-4">
              <Icon name={r === "super_admin" ? "admin_panel_settings" : r === "manager_admin" ? "manage_accounts" : "person"} className={`text-2xl ${
