...
export function ApiDocsPage() {
  // Swagger UI fetches OpenAPI from the same origin under Next.js.
  ...
  return (
    <div className="-mx-8 -my-8 flex flex-col" style={{ minHeight: "calc(100vh - 56px)" }}>
      ...
      <div className="flex items-center gap-3 px-6 py-3 shrink-0"
        ...
        <Icon name="api" className="text-base" style={{ color: "var(--c-primary)", fontVariationSettings: "FILL 1" }} />
      ...
      {specError ? (
        <div className="flex flex-col items-center justify-center flex-1 gap-3 py-16"
          ...
          <Icon name="cloud_off" className="text-4xl" style={{ color: "var(--c-error)" }} />
