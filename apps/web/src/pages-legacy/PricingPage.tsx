      ...
      <header className="glass-header sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm text-on-surface-variant">
            <Link href="/" className="hover:text-ink-text transition-colors">Home</Link>
            <Link href="/#features" className="hover:text-ink-text transition-colors">Features</Link>
          ...
          {PLANS.map((plan) => {
            ...
            return (
              ...
              >
                ...
                {/* CTA */}
                <Link href={plan.name === "Enterprise" ? "mailto:sales@googenie.ai" : "/login"}
                      ...
                      return (
                        <td key={key} className="px-6 py-3.5 text-center">
                          {typeof val === "string" ? (
                            ...
                            <Icon name="check_circle" className="text-base" style={{ color: "var(--c-primary)" }} />
                          ) : (
                            <Icon name="remove" className="text-base" style={{ color: "var(--c-outline)" }} />
                          )}
                        </td>
                      );
                    })}
      ...
      <section className="max-w-3xl mx-auto px-6 pb-28 text-center">
        <div className="glass-panel rounded-3xl p-12 relative overflow-hidden">
          ...
          <div className="relative">
            <Icon name="rocket_launch" className="text-4xl mb-4 block" style={{ color: "var(--c-primary)" }} />
